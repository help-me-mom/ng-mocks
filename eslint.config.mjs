...
export default [
  ...
  ...compat.config({
    root: true,
    plugins: ['@typescript-eslint', 'json', 'unused-imports', 'prefer-arrow', 'unicorn', 'es-x'],
    settings: {
      'import/resolver': {
        typescript: {
    ...
    overrides: [
      ...
      {
        files: ['decorate-angular-cli.js', 'jest.config.js', 'jest.preset.js', 'karma.conf.js', 'webpack.config.js'],
        rules: {
      ...
      {
        files: ['*.json'],
        extends: ['plugin:json/recommended-legacy', 'plugin:prettier/recommended'],
      },
      {
        files: ['*.md'],
      ...
      },
      {
        ...
        extends: ['plugin:json/recommended-with-comments-legacy', 'plugin:prettier/recommended'],
      },
      {
        files: ['*.yaml', '*.yml'],
        parser: 'yaml-eslint-parser',
        extends: ['plugin:yml/prettier', 'plugin:prettier/recommended'],
      },
    ],
  }),
];
