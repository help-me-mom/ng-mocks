...
const projects = [
  ...
  './tests-e2e/tsconfig.vitest.json',
  ...
  './e2e/a20/tsconfig.ivy-zoned.spec.json',
  './e2e/a20/tsconfig.ivy-zoneless.spec.json',
  './e2e/a20/tsconfig.vitest.json',
  './e2e/a21/tsconfig.ivy-zoned.spec.json',
  './e2e/a21/tsconfig.ivy-zoneless.spec.json',
  './e2e/a21/tsconfig.vitest.json',
  './e2e/a22/tsconfig.ivy-zoned.spec.json',
  './e2e/a22/tsconfig.ivy-zoneless.spec.json',
  './e2e/a22/tsconfig.vitest.json',
