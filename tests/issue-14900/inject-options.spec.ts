...
const MISSING = new InjectionToken<string>('missing-14900-options');
...
class LocalFirstService {
  ...
  public readonly parent = inject(RootDependency, {
    skipSelf: true,
    optional: true,
  });
  public readonly repeated = inject(RootDependency);
  public readonly missing = inject(MISSING, { optional: true });
  public readonly missingProvider = inject(MissingDependency, {
    optional: true,
  });
}
...
describe('issue-14900:inject-options', () => {
  beforeEach(() =>
    ngMocks.autoSpy(
