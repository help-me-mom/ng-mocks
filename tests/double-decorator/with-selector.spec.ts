...
describe('double-decorator:with-selector', () => {
  describe('default', () => {
    ...
    it('does not fail', () => {
      ...
      expect(fixture.nativeElement.innerHTML).toContain('<target>directive</target>');
    });
  });
  ...
  describe('hot-fix', () => {
    ...
    beforeAll(() => MockInstance(MyProvider, instance => ngMocks.stub(instance, myProviderMock())));
    ...
    it('provides correct decoration of the directive', () => {
      ...
      expect(fixture.nativeElement.innerHTML).toContain('<target>mock</target>');
    });
  });
  ...
  describe('the-issue', () => {
    ...
    beforeEach(() => MockBuilder(MyComponent, ModuleWithComponent).mock(MyProvider, myProviderMock()));
