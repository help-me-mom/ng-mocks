# karma-remap-istanbul-patched
Temporary, patched version of [karma-remap-istanbul](https://github.com/marcules/karma-remap-istanbul), will be removed when PR [#19](https://github.com/marcules/karma-remap-istanbul/pull/19) is merged.
