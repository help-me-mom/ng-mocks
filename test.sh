...
# Angular CLI 14+ can clear its build cache before testing copied sources.
# Angular 13's cache is cleared by s:files:a13 because its CLI has no cache command.
...
if [ "$1" = "" ] || [ "$1" = "e2e" ]; then
  ...
  docker compose run --rm e2e npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "a14" ]; then
  ...
  docker compose run --rm a14 npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "a15" ]; then
  ...
  docker compose run --rm a15 npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "a16" ]; then
  ...
  docker compose run --rm a16 npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "a18" ]; then
  ...
  docker compose run --rm a18 npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "a19" ]; then
  ...
  docker compose run --rm a19 npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "a20" ]; then
  ...
  docker compose run --rm a20 npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "a21" ]; then
  ...
  docker compose run --rm a21 npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "a22" ]; then
  ...
  docker compose run --rm a22 npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "jasmine" ]; then
  ...
  docker compose run --rm jasmine npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "vitest" ]; then
  ...
  docker compose run --rm vitest npm run ng -- cache clean
...
if [ "$1" = "" ] || [ "$1" = "min" ]; then
  ...
  docker compose run --rm min npm run ng -- cache clean
