...
var resolver_1 = require("./bundler/resolver");
...
var resolver = new resolver_1.Resolver(configuration, dependencyWalker, log4js.getLogger("resolver.karma-typescript"), transformer);
var globals = new globals_1.Globals(configuration, resolver);
var coverage = new coverage_1.Coverage(configuration);
var bundler = new bundler_1.Bundler(configuration, dependencyWalker, globals, log4js.getLogger("bundler.karma-typescript"), resolver, transformer, validator);
...
var framework = new framework_1.Framework(bundler, compiler, configuration, coverage, project, resolver, transformer);
