...
function Reporter(config, sharedProcessedFiles) {
    var coverageReporter = require("karma-coverage/lib/reporter"), isPlainObject = require("lodash.isplainobject"), isString = require("lodash.isstring"), istanbul = require("istanbul"), path = require("path"), remap = require("remap-istanbul/lib/remap"), writeReport = require("remap-istanbul/lib/writeReport"), log;
    ...
    function create(karmaConfig, helper, logger, emitter) {
        var coverageMap, remapOptions = config.remapOptions;
        ...
        this.onRunComplete = function (browsers) {
            ...
            browsers.forEach(function (browser) {
                var coverage = coverageMap.get(browser), unmappedCollector = new istanbul.Collector();
                if (!coverage) {
                    return;
                }
