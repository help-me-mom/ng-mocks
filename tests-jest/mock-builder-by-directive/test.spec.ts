...
describe('MockBuilderByDirective:real', () => {
  ...
  it('should render', () => {
    ...
    const element = ngMocks.find(fixture.debugElement, InternalComponent, undefined);
...
describe('MockBuilderByDirective:mock', () => {
  ...
  it('should find mock', () => {
    const fixture = MockRender(InternalComponent);
    const element = ngMocks.find(fixture.debugElement, MockComponent(InternalComponent), undefined);
    expect(element).toBeDefined();
  });
