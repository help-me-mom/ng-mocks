...
describe('structural-directive-as-ng-for:mock', () => {
  ...
  it('mocks customNgIf properly', () => {
    ...
    expect(fixture.nativeElement.innerHTML).toContain(' $implicit: fromDirective: ');
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.innerHTML).toContain(' $implicit:true fromDirective:false ');
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.innerHTML).toContain(' $implicit:false fromDirective:true ');
  });
  ...
  it('mocks CustomNgForWithOfDirective properly', () => {
    ...
    // By default mocked structural directives are rendered with undefined variables.
    expect(fixture.nativeElement.innerHTML).toContain(' w/ 00 ');
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.innerHTML).toContain(' w/ MainValueMyIndex10 ');
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.innerHTML).toContain(' w/ MainValue2MyIndex201 ');
  });
  ...
  it('mocks customNgForWithoutOf properly', () => {
    ...
    // By default mocked structural directives are rendered with undefined variables.
    expect(fixture.nativeElement.innerHTML).toContain(' w/o 00 ');
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.innerHTML).toContain(' w/o MainValueMyIndex10 ');
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.innerHTML).toContain(' w/o MainValue2MyIndex201 ');
  });
  ...
  it('searches for related directive', () => {
    ...
    mockedDirective = ngMocks.get(debugElement, MockDirective(CustomNgForWithoutOfDirective));
