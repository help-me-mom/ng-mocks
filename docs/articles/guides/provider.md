...
```ts title="https://github.com/help-me-mom/ng-mocks/blob/main/examples/TestProvider/test.spec.ts"
...
```ts title="https://github.com/help-me-mom/ng-mocks/blob/main/examples/TestProviderWithDependencies/test.spec.ts"
...
```ts title="https://github.com/help-me-mom/ng-mocks/blob/main/examples/TestProviderWithUseClass/test.spec.ts"
import { Injectable, NgModule } from '@angular/core';
...
```ts title="https://github.com/help-me-mom/ng-mocks/blob/main/examples/TestProviderWithUseValue/test.spec.ts"
import { Injectable, NgModule } from '@angular/core';
...
```ts title="https://github.com/help-me-mom/ng-mocks/blob/main/examples/TestProviderWithUseExisting/test.spec.ts"
import { Injectable, NgModule } from '@angular/core';
...
```ts title="https://github.com/help-me-mom/ng-mocks/blob/main/examples/TestProviderWithUseFactory/test.spec.ts"
import { Injectable, NgModule } from '@angular/core';
