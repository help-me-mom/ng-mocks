...
description: Information on how to test `DomSanitizer` usage in Angular
...
```ts title="https://github.com/help-me-mom/ng-mocks/blob/main/examples/MockSanitizer/test.spec.ts"
