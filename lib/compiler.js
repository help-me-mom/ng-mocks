    ...
    function collectRequiredModules() {
        ...
        Object.keys(sourceFileCache).forEach(function(key) {
            ...
            if(cachedItem.sourceFile.resolvedModules && !cachedItem.sourceFile.isDeclarationFile) {
                ...
                Object.keys(cachedItem.sourceFile.resolvedModules).forEach(function(resolvedModule) {

                    var filename = ts.hasResolvedModule(cachedItem.sourceFile, resolvedModule) ?
                        cachedItem.sourceFile.resolvedModules[resolvedModule].resolvedFileName : "";
