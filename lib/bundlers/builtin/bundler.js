...
function Bundler() {
    ...
    function initialize(karmaConfig, bundlerOptions, logger) {
        ...
        ignoredModuleNames = (bundlerOptions && bundlerOptions.ignoredModuleNames) || [];
        nodeGlobals = (bundlerOptions && bundlerOptions.nodeGlobals !== undefined) ?
            bundlerOptions.nodeGlobals : true;
