...
function Bundler() {
    ...
    function initialize(karmaConfig, karmaTypescriptConfig, logger) {
        ...
        bundleQueue.unshift({
            ...
            filename: "globals.js",
            source: "window.process=require('process/browser');" + os.EOL +
    ...
    function addLoaderFunction(module) {
        ...
        return "window.wrappers['" + fixWindowsPath(module.filename) + "']=" +
                   "[function(require,module,exports,global,__dirname,__filename){ " + module.source +
                   os.EOL + "},'" +
    ...
    function addDynamicDependencies(expressions, moduleNames, requiredModule) {
        ...
        expressions.forEach(function(requireStatement) {

            var dynamicModuleName = parseDynamicRequire(requireStatement);
