function Framework(bundler, compiler, nodeModulesLoader) {
    ...
    var path = require("path"),
        ...
        create = function(config, logger) {
            ...
            bundler.initialize(logger.create("bundler.karma-typescript"));
            ...
            if(!hasCommonJsFramework(config)) {
                ...
                config.files.push({
                    pattern: path.join(__dirname, "bundlers/builtin/commonjs-bootstrap.js"),
                    included: true,
                    served: true,
                    watched: false
                });
