...
var createPreprocessor = function(_config, helper, logger) {
    ...
    return function(content, file, done) {
        ...
        try {
            ...
            result = loadModules(file.path, transpileOutput.outputText);
            result = createSourcemap(file, content, result, transpileOutput.sourceMapText);
...
function addLoaderFunction(moduleName, source) {
    ...
    return "window.__cjs_module__ = window.__cjs_module__ || {}; window.__cjs_module__['" + path.normalize(moduleName) + "'] = function(require, module, exports) { " + os.EOL + source + os.EOL + "}\n";
}
