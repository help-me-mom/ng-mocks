function Bundler(config) {
    ...
    function resolveModulesAsync(requiringModule, requiredModule) {
        ...
        if(lookupNameCacheAsync[lookupName]) {
            requiredModule.filename = lookupNameCacheAsync[lookupName];
            return Promise.resolve(requiredModule);
        }
        ...
        function handleResolve(filename) {

            requiredModule.filename = filename;
            lookupNameCacheAsync[lookupName] = requiredModule.filename;
        ...
        function handleSource(source) {
            ...
            if(typeof source === "string") {
                ...
                requiredModule.source = removeSourceMapUrl(source);
