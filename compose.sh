...
if [ "$1" = "" ] || [ "$1" = "root" ]; then
  docker compose up --build --exit-code-from ng-mocks -- ng-mocks
...
if [ "$1" = "" ] || [ "$1" = "docs" ]; then
  docker compose up --build --exit-code-from docs -- docs
  cd ./docs
  nvm install
  nvm use
  cd ..
...
if [ "$1" = "" ] || [ "$1" = "a5" ] || [ "$1" = "a5es5" ]; then
  docker compose up --build --exit-code-from a5es5 -- a5es5
...
if [ "$1" = "" ] || [ "$1" = "a5" ] || [ "$1" = "a5es2015" ]; then
  docker compose up --build --exit-code-from a5es2015 -- a5es2015
...
if [ "$1" = "" ] || [ "$1" = "a6" ]; then
  docker compose up --build --exit-code-from a6 -- a6
...
if [ "$1" = "" ] || [ "$1" = "a7" ]; then
  docker compose up --build --exit-code-from a7 -- a7
...
if [ "$1" = "" ] || [ "$1" = "a8" ]; then
  docker compose up --build --exit-code-from a8 -- a8
...
if [ "$1" = "" ] || [ "$1" = "a9" ]; then
  docker compose up --build --exit-code-from a9 -- a9
...
if [ "$1" = "" ] || [ "$1" = "a10" ]; then
  docker compose up --build --exit-code-from a10 -- a10
...
if [ "$1" = "" ] || [ "$1" = "a11" ]; then
  docker compose up --build --exit-code-from a11 -- a11
...
if [ "$1" = "" ] || [ "$1" = "a12" ]; then
  docker compose up --build --exit-code-from a12 -- a12
...
if [ "$1" = "" ] || [ "$1" = "a13" ]; then
  docker compose up --build --exit-code-from a13 -- a13
...
if [ "$1" = "" ] || [ "$1" = "a14" ]; then
  docker compose up --build --exit-code-from a14 -- a14
...
if [ "$1" = "" ] || [ "$1" = "a15" ]; then
  docker compose up --build --exit-code-from a15 -- a15
...
if [ "$1" = "" ] || [ "$1" = "a16" ]; then
  docker compose up --build --exit-code-from a16 -- a16
...
if [ "$1" = "" ] || [ "$1" = "a17" ]; then
  docker compose up --build --exit-code-from a17 -- a17
...
if [ "$1" = "" ] || [ "$1" = "a18" ]; then
  docker compose up --build --exit-code-from a18 -- a18
...
if [ "$1" = "" ] || [ "$1" = "a19" ]; then
  docker compose up --build --exit-code-from a19 -- a19
...
if [ "$1" = "" ] || [ "$1" = "a20" ]; then
  docker compose up --build --exit-code-from a20 -- a20
...
if [ "$1" = "" ] || [ "$1" = "a21" ]; then
  docker compose up --build --exit-code-from a21 -- a21
...
if [ "$1" = "" ] || [ "$1" = "a22" ]; then
  docker compose up --build --exit-code-from a22 -- a22
...
if [ "$1" = "" ] || [ "$1" = "jasmine" ]; then
  docker compose up --build --exit-code-from jasmine -- jasmine
...
if [ "$1" = "" ] || [ "$1" = "jest" ]; then
  docker compose up --build --exit-code-from jest -- jest
fi

if [ "$1" = "" ] || [ "$1" = "vitest" ]; then
  docker compose up --build --exit-code-from vitest -- vitest
fi

if [ "$1" = "" ] || [ "$1" = "min" ]; then
  docker compose up --build --exit-code-from min -- min
...
if [ "$1" = "" ] || [ "$1" = "nx" ]; then
  docker compose up --build --exit-code-from nx -- nx
fi
