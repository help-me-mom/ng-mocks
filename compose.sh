...
if [ "$1" = "" ] || [ "$1" = "root" ]; then
  ...
  docker compose up --build -- ng-mocks && \
    ...
    nvm install && \
    nvm use && \
    ( [ ! -d "${PUPPETEER_CACHE_DIR:-$HOME/.cache/puppeteer}" ] || find "${PUPPETEER_CACHE_DIR:-$HOME/.cache/puppeteer}" -mindepth 2 -maxdepth 2 -type d -empty -delete ) && \
...
if [ "$1" = "" ] || [ "$1" = "a5" ] || [ "$1" = "a5es5" ]; then
  docker compose run --rm a5es5 sh -ec '[ ! -d /app/node_modules/puppeteer/.local-chromium ] || find /app/node_modules/puppeteer/.local-chromium -mindepth 1 -maxdepth 1 -type d -empty -delete'
  docker compose up --build -- a5es5 && \
    ...
    nvm install && \
    nvm use && \
    ( [ ! -d ./node_modules/puppeteer/.local-chromium ] || find ./node_modules/puppeteer/.local-chromium -mindepth 1 -maxdepth 1 -type d -empty -delete ) && \
...
if [ "$1" = "" ] || [ "$1" = "a5" ] || [ "$1" = "a5es2015" ]; then
  docker compose run --rm a5es2015 sh -ec '[ ! -d /app/node_modules/puppeteer/.local-chromium ] || find /app/node_modules/puppeteer/.local-chromium -mindepth 1 -maxdepth 1 -type d -empty -delete'
...
if [ "$1" = "" ] || [ "$1" = "a6" ]; then
  docker compose run --rm a6 sh -ec '[ ! -d /app/node_modules/puppeteer/.local-chromium ] || find /app/node_modules/puppeteer/.local-chromium -mindepth 1 -maxdepth 1 -type d -empty -delete'
...
if [ "$1" = "" ] || [ "$1" = "a7" ]; then
  docker compose run --rm a7 sh -ec '[ ! -d /app/node_modules/puppeteer/.local-chromium ] || find /app/node_modules/puppeteer/.local-chromium -mindepth 1 -maxdepth 1 -type d -empty -delete'
